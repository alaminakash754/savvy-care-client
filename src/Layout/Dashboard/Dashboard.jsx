                    ...
                    <ul className="menu">

                        {
                            isAdmin ?
                                <>
                                    <h3 className="my-3">
                                        <h1 className="font-bold text-2xl text-blue-500 ">Smile Savvy Care </h1>
                                        <div className="flex gap-4 mt-4">
                                            <img className="rounded-3xl h-16 w-16" src={user.photoURL} alt="" />
                                            <div>
                                                <h1> WellCome, <br /> <span className="text-blue-500 font-medium text-xl">{user.displayName}</span> </h1>
                                    ...
                                    <li>
                                        <NavLink to='/dashboard/addDoctor'>
                                            <FaPlus></FaPlus> Add a Doctor</NavLink>
                                    </li>
