            ...
            <div className="navbar bg-opacity-30 text-purple lg:w-[1150px]  bg-gradient-to-r from-cyan-700 to-blue-900 rounded-xl " data-aos="zoom-in-up" data-aos-duration="2000">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-blue-500 rounded-box w-52 text-white">
                            {navLinks}
                        </ul>
                    </div>
                    <img className="w-32 h-12 rounded-2xl" src="https://i.ibb.co/ccWYw9W/logo.jpg" alt="" />
                </div>
