...
const Services = () => {
    ...
    return (
        <div className='max-w-5xl mx-auto'>
            <SectionTitle subHeading='Services' heading='Ours first priority is our patient'></SectionTitle>
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 ">
            <div><img className='rounded-lg w-full h-[900px]' src={doctor} alt="" /></div>
            <div>
                <div>
